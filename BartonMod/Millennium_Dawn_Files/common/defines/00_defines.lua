...
NTechnology = {
	...
	MAX_TECH_SHARING_BONUS = 0.3,			-- Max technology sharing bonus that can be applied instantly
},
...
NMilitary = {
	...
	ENEMY_AIR_SUPERIORITY_IMPACT = -0.6,           -- effect on defense due to enemy air superiorty
	ENEMY_AIR_SUPERIORITY_SPEED_IMPACT = -0.6,     -- effect on speed due to enemy air superiority
	...
	ENCIRCLED_PENALTY = -0.5,                      -- penalty when completely encircled
...
NAI = {
	...
	PARADROP_MISSION_FACTOR = 2.0,						-- AI paradrop mission factor
	KAMIKAZE_MISSION_FACTOR = 0.5,						-- AI naval kamikaze mission factor
	PORT_STRIKE_MISSION_FACTOR = 1.0,					-- When the AI picks units for a front, it tries to spread out a bit which units it grabs.
	...
	STR_BOMB_MIN_EXCORT_WINGS = 2,					-- AI port strike mission factor
	...
	REVISITED_PROV_PENALTY_FACTOR = 1.5,					-- Min amount of airwings requested to excort operations
